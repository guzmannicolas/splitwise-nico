      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-wrap justify-center gap-8 text-sm font-semibold text-slate-600 dark:text-slate-300">
            ...
            <Link href="/privacy" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Privacidad</Link>
            <Link href="https://github.com/guzmannicolas/splitwise-nico" target="_blank" className="flex items-center gap-2 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-slate-100 dark:border-slate-900 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-slate-400 dark:text-slate-500 text-xs">
            © {currentYear} Dividi2. No usamos cookies de rastreo. <Link href="/privacy" className="underline hover:text-blue-500">Ver Política</Link>
          </p>
